<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
    ...
    <div class="m-header">
        ...
        <a href="#!" class="b-brand">
            ...
            <img src="assets/images/logo_kemenag.png" alt="" class="logo">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu profile-notification ">
                            <ul class="pro-body">
                                ...
                                <li><a href="logout.php" class="dropdown-item"><i class="fas fa-circle"></i> Lock Screen</a></li>
                            </ul>
                        </div>
                    </div>
                </li> -->
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        ...
                        <ul class="pro-body">
                            ...
                            <li><a href="email_inbox.html" class="dropdown-item"><i class="feather icon-mail"></i> My
                                    Messages</a></li>
                            <li><a href="logout.php" class="dropdown-item"><i class="feather icon-lock"></i> Lock
                                    Screen</a></li>
                        </ul>
                    </div>
                </div>
